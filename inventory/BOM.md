...
| DS18B20 temperature sensor | 1 | Confirmed | `README.md`, `src/main.zig` | Firmware initializes a DS18B20 driver on GPIO22. |
...
| Binary on/off toggle switch | 1 | Confirmed | `src/main.zig` | Wired to GND on GPIO18 with internal pull-up (active-low); toggling it forces the heater off without stopping sensing/logging. |
